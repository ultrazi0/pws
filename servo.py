...
class Servo():
    ...
    def __init__(self, pin, dy=3.5, r=7.5, start_angle=36, lower_border=None, upper_border=None, 
        ...
        :param dy: horizontal distance between stepper axis and canon axis [mm]
        :param r: radius of a disk that is connected to the canon [mm]
        :param start_angle: this parameter is used to set up the zero-position of the canon correctly
        ...
        # Find min and max angles so that servo's 0 would correspond with canon's 0
        alpha0 = degrees(asin(dy/r))
        # To insure that the servo rotates in the right direction, minimum and maximun angles should be switched
        ...
        min_pulse_width=min_pulse_width, max_pulse_width=max_pulse_width, initial_angle=self.initial_angle, pin_factory=factory)
