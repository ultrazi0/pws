...
from math_part import find_middle, translate_origin_to_cannon, translate_image_point, sin, cos, find_angle_with_drag, radians, pi, atan, degrees, translate_point_to_vertical_plane
...
if __name__ == '__main__':
    ...
    coordinates_of_camera_with_respect_to_the_cannon = (0.034, -0.1, 0.045)  # Cannon itself, needed for correct vertical angle
